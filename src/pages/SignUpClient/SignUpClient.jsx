...
export function SignUpClient() {
    ...
    function handleSetectCity(e) {
      ...
      async function handleNewAccount(e) {
        ...
        if(avatarClient === "") {
            toast.error("Carregue sua imagem de perfil");
            return
        }
        toast.info("Criando conta. Aguarde...");
                ...
                const status = "Ativo";
                const type = "client";
               createAccount({type, name, email, phone, whatsapp, password, status, verified, avatar:avatarClient, cep, city, uf})
                console.log({type, name, email, phone, whatsapp, password, status, verified, avatar:avatarClient, cep, city, uf})
      }

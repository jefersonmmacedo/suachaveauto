...
export function Announce() {
    ...
    function HandleOpen(e) {
        ...
        window.open("https://wa.me/5521999589219?text=Olá. Gostaria de saber mais detalhes sobre os planos e serviços que a Sua Chave Auto pode me oferecer")
      }
...
<div className="Announce">
    ...
    <div className="MainAnnounce">
            <div className="bloco">
                ...
                <div className="textAnnounce">
                    <h1>A sua <span>agência</span> <br />merece ser 100% <span>digital!</span></h1>
                    <h3>Portal/catálogo de autos + Sistema de gestão completo + Site para agências e consultores. <br /> Tudo preparado para conectar seus autos a novos clientes.</h3>
    ...
    <div className="howItWorks">
        ...
        <div className="iconsWorks">
            <div className="iconWork">
                <IoIdCardOutline />
                <h3>Cadastre-se</h3>
                <h4>Realize seu cadastro para agência ou corretor de forma rápida e objetiva.</h4>
            </div>
            <div className="iconWork">
                <IoQrCodeOutline />
    ...
    <div className="beneficies">
        ...
        <h2>Gerencie sua <span>agência</span>:</h2>
                ...
                <a className="linkText" href="https://wa.me/5521999589219?text=Olá. Gostaria de saber mais detalhes sobre os planos e serviços que a Sua Chave Auto pode me oferecer" target="_Blank"> Clique aqui e saiba mais </a>
